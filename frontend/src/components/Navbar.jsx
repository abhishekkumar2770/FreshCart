...
//       navigate("/products");
//     }
//   }, [searchQuery, navigate]); // ✅ added dependencies

//   return (
//     <nav className="flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 py-4 border-b border-gray-300 bg-white relative transition-all">
//       <Link to="/">
//         <h2 className="text-2xl font-bold text-primary">FreshCart</h2>
//       </Link>
        ...
        {user ? (
          ...
          <div className="flex flex-col gap-2 w-full">
            <button
              ...
              className="cursor-pointer w-full px-8 py-2 bg-indigo-500 hover:bg-indigo-600 transition text-white rounded-full"
            >
              Login
            </button>
            ...
            <button
              ...
              className="cursor-pointer w-full px-8 py-2 bg-green-500 hover:bg-green-600 transition text-white rounded-full"
            >
              Login as Seller
            </button>
          </div>
